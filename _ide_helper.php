...
namespace ShawnSandy\PageKit\Facades { 
    ...
    class PageFacade {
        ...
        {
            return \ShawnSandy\PageKit\Page::routes();
        }
...
namespace Collective\Html { 
    ...
    class HtmlFacade {
         ...
         * @static 
         */ 
        public static function entypoStylesheet()
        {
            return \Collective\Html\HtmlBuilder::entypoStylesheet();
        }
         ...
         * @static 
         */ 
        public static function entypoFont($name = 'circle')
        {
            return \Collective\Html\HtmlBuilder::entypoFont($name);
        }
         ...
         * @static 
         */ 
        public static function microTip()
        {
            return \Collective\Html\HtmlBuilder::microTip();
        }
         ...
         * @static 
         */ 
        public static function tooltip($tip = 'Hey! Tip me', $position = 'bottom')
        {
            return \Collective\Html\HtmlBuilder::tooltip($tip, $position);
        }
         ...
         * @static 
         */ 
        public static function tableRows($table_data)
        {
            return \Collective\Html\HtmlBuilder::tableRows($table_data);
        }
...
namespace ShawnSandy\Extras { 
    ...
    class ExtrasFacade {
         ...
         * @static 
         */ 
        public static function toHtmlString($html_String)
        {
            return \ShawnSandy\Extras\Extras::toHtmlString($html_String);
        }
         ...
         * @static 
         */ 
        public static function glide($path, $dir)
        {
            return \ShawnSandy\Extras\Extras::glide($path, $dir);
        }
         ...
         * @static 
         */ 
        public static function glidePublic($dir, $photo)
        {
            return \ShawnSandy\Extras\Extras::glidePublic($dir, $photo);
        }
         ...
         * @static 
         */ 
        public static function str_limit($string = '', $limit = 20, $trail = '...')
        {
            return \ShawnSandy\Extras\Extras::str_limit($string, $limit, $trail);
        }
...
namespace ShawnSandy\Extras\Apps\Maps { 
    ...
    class MapsFacade {
         ...
         * @static 
         */ 
        public static function getMapData($address, $apiKey)
        {
            return \ShawnSandy\Extras\Apps\Maps\Maps::getMapData($address, $apiKey);
        }
...
namespace  { 
    ...
    class Pages extends \ShawnSandy\PageKit\Facades\PageFacade {}

    class Flash extends \Laracasts\Flash\FlashServiceProvider {}
